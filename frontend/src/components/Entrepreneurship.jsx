...
const Entrepreneurship = () => {
  return (
    <section id="entrepreneurship" className="py-32 bg-zinc-950 text-white border-t border-gray-900">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="mb-16">
          <h3 className="text-sm tracking-widest uppercase text-gray-500 mb-4">Entrepreneurship Competency</h3>
        ...
        <div className="mb-12">
          <div className="border-l-2 border-gray-800 pl-8 mb-12">
            <div className="mb-8">
              <img 
                src="https://customer-assets.emergentagent.com/job_db1876d2-bfe7-4217-8fe1-4f5930ef662d/artifacts/ywvnmk13_FSE301.jpg" 
                alt="FSE 301 Entrepreneurship Class"
                className="w-full rounded-lg shadow-lg"
              />
            </div>
            <h3 className="text-3xl font-bold mb-2">FSE 301</h3>
            <p className="text-gray-500 mb-8">Entrepreneurship Course</p>
            ...
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-3 text-white">Research & Critical Thinking</h4>
                  <p className="text-sm text-gray-400 leading-relaxed">
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-3 text-white">Pitch Development & Funding</h4>
                  <p className="text-sm text-gray-400 leading-relaxed">
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-3 text-white">Stakeholder Communication</h4>
                  <p className="text-sm text-gray-400 leading-relaxed">
              ...
              <div className="bg-zinc-900 rounded-lg p-8 border border-gray-800">
                <h4 className="text-xl font-bold mb-4">Key Skills Developed</h4>
