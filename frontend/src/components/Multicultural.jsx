...
const Multicultural = () => {
  return (
    <section id="multicultural" className="py-32 bg-black text-white border-t border-gray-900">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="mb-16">
          <h3 className="text-sm tracking-widest uppercase text-gray-500 mb-4">Multicultural Competency</h3>
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-16">
          ...
          <div className="border-l-2 border-gray-800 pl-8">
            ...
            <div className="space-y-6">
              <div>
                <h5 className="font-semibold text-white mb-2">Cultural Significance of Food</h5>
              ...
              <div>
                <h5 className="font-semibold text-white mb-2">Globalization & Food Systems</h5>
                <p className="text-sm text-gray-400 leading-relaxed">
              ...
              <div>
                <h5 className="font-semibold text-white mb-2">Cross-Cultural Communication</h5>
                <p className="text-sm text-gray-400 leading-relaxed">
          ...
          <div className="border-l-2 border-gray-800 pl-8">
            ...
            <div className="space-y-6">
              <div>
                <h5 className="font-semibold text-white mb-2">Language as Cultural Identity</h5>
                <p className="text-sm text-gray-400 leading-relaxed">
              ...
              <div>
                <h5 className="font-semibold text-white mb-2">Navigating Cultural Conflicts</h5>
                <p className="text-sm text-gray-400 leading-relaxed">
              ...
              <div>
                <h5 className="font-semibold text-white mb-2">Global Collaboration Skills</h5>
                <p className="text-sm text-gray-400 leading-relaxed">
        ...
        <div className="border-l-2 border-gray-800 pl-8">
          <h3 className="text-2xl font-bold mb-4">Value of Multicultural Competency</h3>
