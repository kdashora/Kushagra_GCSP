...
const ServiceLearning = () => {
  return (
    <section id="service" className="py-32 bg-zinc-950 text-white border-t border-gray-900">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="mb-16">
          <h3 className="text-sm tracking-widest uppercase text-gray-500 mb-4">Social Consciousness Competency</h3>
        ...
        <div className="mb-16 border-l-2 border-gray-800 pl-8">
          <h3 className="text-3xl font-bold mb-2">EPICS Program</h3>
          <p className="text-gray-500 mb-8">Devils Prosthetics - Electrical Design Lead</p>

          <h4 className="text-2xl font-bold mb-6 text-white">3D-Printed Myoelectric Prosthetic Development</h4>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              <h5 className="text-lg font-semibold mb-3 text-white">Leadership Role</h5>
            ...
            <div>
              <h5 className="text-lg font-semibold mb-3 text-white">Community Partnership</h5>
              <p className="text-sm text-gray-400 leading-relaxed">
            ...
            <div>
              <h5 className="text-lg font-semibold mb-3 text-white">EPICS Elite Funding</h5>
              <p className="text-sm text-gray-400 leading-relaxed">
                The success of securing <span className="font-semibold text-white">$10,000 in EPICS Elite Pitch Funding</span> highlighted the effectiveness of our collaborative approach in translating our vision into reality and securing resources to advance our project.
              </p>
            </div>
          </div>

          <div className="bg-zinc-900 rounded-lg p-8 border border-gray-800 mb-8">
            <h4 className="text-xl font-bold mb-4">Community Impact & Social Responsibility</h4>
        ...
        <div className="mb-16 border-l-2 border-gray-800 pl-8">
          ...
          <h4 className="text-2xl font-bold mb-6 text-white">Bridging Communities & Building Futures</h4>
          <p className="text-gray-400 leading-relaxed text-lg mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
              <h5 className="text-lg font-semibold mb-4 text-white">Leadership Evolution</h5>
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                <li className="flex items-start gap-3">
                  ...
                  <span><span className="font-semibold text-white">Poly Co-Tour Director:</span> Coordinating campus tours and visitor experiences</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-gray-600 mt-1">•</span>
                  <span><span className="font-semibold text-white">Poly President:</span> Leading the organization and strategic initiatives</span>
                </li>
              </ul>
            </div>

            <div>
              <h5 className="text-lg font-semibold mb-4 text-white">Diverse Responsibilities</h5>
              <p className="text-sm text-gray-400 leading-relaxed mb-4">
          ...
          <div className="bg-zinc-900 rounded-lg p-8 border border-gray-800">
            <h5 className="text-lg font-semibold mb-3 text-white">Personal Growth</h5>
            <p className="text-gray-400 leading-relaxed">
        ...
        <div className="border-l-2 border-gray-800 pl-8">
          <h3 className="text-2xl font-bold mb-4">Connection to Joy of Living Theme & Engineering</h3>
